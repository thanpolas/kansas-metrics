...
Fetch.prototype._processResults = Promise.method(function(usageResults,
  ...
  usageResults.forEach(function(usageResult, index) {
    ...
    // kansas-metrics-test:kansas:usage:2014-05-01:0aP5wSKHu09PTzvZx2EUv91y08gpqSVq
    console.log(usageResult, index, this.canonicalKeys[index], datePeriod, month, year);
  }, this);

  console.log('RESSSssss:', tokenItemResults);
